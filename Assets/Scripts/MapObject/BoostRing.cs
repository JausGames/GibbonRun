...
public class SpeedRing : MapObject
{
    ...
    public float minBoostSpeed = 15f;    // Vitesse minimale garantie apr�s boost
    public float boostDuration = 0.5f;   // Temps pendant lequel la vitesse est boost�e (optionnel)
